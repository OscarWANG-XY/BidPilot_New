        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="文档标题"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "analysis_result",
                    models.JSONField(
                        blank=True, db_index=True, null=True, verbose_name="分析结果"
                    ),
                ),
                (
                    "extracted_elements",
                ...
                (
                    ...
                    models.DurationField(
                        blank=True, null=True, verbose_name="处理耗时"
                    ),
                ),
                (
                    "analysis_version",
                    models.CharField(
                        default="1.0.0", max_length=50, verbose_name="分析器版本"
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    "analyzed_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="分析完成时间"
                    ),
                ),
                (
                    "confirmed_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="doc_analysi_status_6bc99c_idx",
                    ),
                    models.Index(
                        fields=["project", "status"],
                        name="doc_analysi_project_9640ed_idx",
                    ),
                ],
