...
class DocxOutlineAnalyzerStep(PipelineStep[EXAMPLE_INPUT, EXAMPLE_OUTPUT]):
    ...
    def validate_input(self, data: EXAMPLE_INPUT) -> bool:
        """
        验证输入数据是否有效
        """
        return True
    ...
    def process(self, data: EXAMPLE_INPUT) -> EXAMPLE_OUTPUT:
        """
