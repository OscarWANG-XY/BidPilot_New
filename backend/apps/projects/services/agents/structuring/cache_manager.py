...
class CacheManager:
    ...
    @classmethod
    def cache_state(cls, project_id: str, state_data: Dict[str, Any], timeout=None) -> bool:
        """
        缓存状态数据
    ...
    @classmethod
    def get_state(cls, project_id: str) -> Optional[Dict[str, Any]]:
        """
        获取缓存的状态数据
    ...
    @classmethod
    def cache_document(cls, project_id: str, doc_type: str, document: Dict[str, Any], timeout=None) -> bool:
        """
        缓存文档数据
    ...
    @classmethod
    def get_document(cls, project_id: str, doc_type: str) -> Optional[Dict[str, Any]]:
        """
        获取缓存的文档数据
    ...
    @classmethod
    def clear_project_cache(cls, project_id: str) -> bool:
        """
        清除项目的所有缓存
