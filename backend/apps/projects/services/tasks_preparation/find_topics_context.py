...
请根据语义为我识别话题范围【{topic_list}】里，每个话题详述的对应章节？

如果一个话题涉及多各章节，请列出所有章节。 
...
- 示例：
[
    {"话题": 内容, "章节": str, "level": int, "path": [int], "原因": str}, 
    {"话题": 内容, "章节": str, "level": int, "path": [int], "原因": str}
]
每个话题对应的每个章节单独输出一条数据
...
#    def simulate_prompt(self) -> str:
    def simulate_prompt(self) -> Tuple[str, List[Dict[str, Any]]]:
        ...
        return simulated_prompt, formatted_prompt
