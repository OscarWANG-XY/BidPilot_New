    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_%(class)s', to='projects.projectstage', verbose_name='所属阶段')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('operation_id', models.UUIDField(db_index=True, default=uuid.uuid4, help_text='同一操作中的多个字段变更共享相同的操作ID', verbose_name='操作ID')),
                ('object_id', models.UUIDField(verbose_name='任务ID')),
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype', verbose_name='任务类型')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['content_type', 'object_id', 'changed_at'], name='projects_ta_content_f7ae3c_idx'),
        ),
        migrations.AddIndex(
            model_name='taskchangehistory',
