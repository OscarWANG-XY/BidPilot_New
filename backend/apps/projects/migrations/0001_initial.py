    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_active_stage', models.CharField(choices=[('INITIALIZATION', '项目初始化'), ('TENDER_ANALYSIS', '招标文件分析'), ('BID_WRITING', '投标文件编写'), ('BID_REVISION', '投标文件修订'), ('BID_PRODUCTION', '生产投标文件')], default='INITIALIZATION', max_length=20, verbose_name='当前活动阶段')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('from_stage', models.CharField(choices=[('INITIALIZATION', '项目初始化'), ('TENDER_ANALYSIS', '招标文件分析'), ('BID_WRITING', '投标文件编写'), ('BID_REVISION', '投标文件修订'), ('BID_PRODUCTION', '生产投标文件')], max_length=20, verbose_name='原阶段')),
                ('to_stage', models.CharField(choices=[('INITIALIZATION', '项目初始化'), ('TENDER_ANALYSIS', '招标文件分析'), ('BID_WRITING', '投标文件编写'), ('BID_REVISION', '投标文件修订'), ('BID_PRODUCTION', '生产投标文件')], max_length=20, verbose_name='新阶段')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stage_type', models.CharField(choices=[('INITIALIZATION', '项目初始化'), ('TENDER_ANALYSIS', '招标文件分析'), ('BID_WRITING', '投标文件编写'), ('BID_REVISION', '投标文件修订'), ('BID_PRODUCTION', '生产投标文件')], max_length=20, verbose_name='阶段类型')),
