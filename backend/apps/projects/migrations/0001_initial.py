    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiptap_content', models.JSONField(blank=True, help_text='存储tiptap内容', null=True, verbose_name='tiptap内容')),
                ('stage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='projects.projectstage', verbose_name='所属阶段')),
            ],
            options={
                'verbose_name': '任务',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='change_histories', to='projects.task', verbose_name='任务')),
            ],
            options={
                'verbose_name': '任务变更历史',
        ...
        migrations.AddIndex(
            model_name='task',
            index=models.Index(fields=['stage', 'type'], name='projects_ta_stage_i_bf243b_idx'),
        ),
        migrations.AddIndex(
            model_name='task',
