...
class Cache:
    ...
    def get_cache_keys(self) -> str:
        ...
        return {
            ...
            ## inspection_stage
            'inspection_progress': f"{self.KEY_PREFIX}{self.project_id}:inspection_list",   # 进度管理表格
            'inspection_checklist': f"{self.KEY_PREFIX}{self.project_id}:inspection_checklist",

            # step_results
            'chapters_md': f"{self.KEY_PREFIX}{self.project_id}:chapters_md",
