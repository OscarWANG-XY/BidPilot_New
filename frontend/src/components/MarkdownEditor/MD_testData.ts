...
正在等待分析结果...正在准备分析文档大纲...<!-- index: 50 -->## 四、招标最高限价：1840 万元<!-- index: 51 -->采购内容、数量及简要技术要求: 52 --> 六、合格投标人的资格要求(本项目采用资格后审): 64 --> 七、招标公告的发布： 66 -->八、招标文件的发售：4 -->九、投标保证金： index: 77 -->截止时间和地点：: 81 --> 十一、开标时间及地点：: 84 -->评标办法：综合评分法。: 85 -->业务咨询 93 --> 第二章 招标需求 index: 94 -->## 一、概述
...
export const streamingExample3 = `
正在准备分析文档大纲...
<!-- index: 50 -->
## 四、招标最高限价：1840 万元
...
export const streamingExample2 = `# 大模型流式输出示例
